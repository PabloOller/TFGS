...
<head>
    ...
    <title>DualSpeed | Correo de recuperación</title>
    <link rel="stylesheet" href="./css/forgotpassword.css"></link>
...
<body>
    <div class="popup">
        <form class="form" action="confirmationFP.php" method = "POST">
            <div class="icon">
                <svg fill="none" viewBox="0 0 34 34" height="34" width="34">
            ...
            <div class="note">
                <label class="title">Correo de recuperación</label>
                <span class="subtitle">Escribe el correo al que quieres que llegue el email con la recuperación de la cuenta.</span>
            </div>
            <input placeholder="Ingresa tu correo" title="Enter your e-mail" name="email" type="email" class="input_field">
